...
public class CalculatorTest {
    ...
    public void calculateBSITest(){
        ...
        assertEquals(new Double(0.03), bsi, 0.01);
        ...
        assertEquals(new Double(0.015), bsi,0.01);
    }
}
